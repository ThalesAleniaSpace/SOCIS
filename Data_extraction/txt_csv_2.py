...
def  getvalues(sno,final_filetype,lines,powerstate_index,dir1,final_index):
    ...
    return_list.append(float(final_currenttime_val))
    return_list.append(float(final_currentstable_val))
    return_list.append(float(final_currentminmax_val))
    return_list.append(final_power_spec)
    return_list.append(float(final_currenttime_spec))
    return_list.append(float(final_currentstable_spec))
    return_list.append(float(final_currentminmax_spec))
